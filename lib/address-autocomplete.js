...
(function () {
  ...
  // Poststed kommer i VERSALER fra Geonorge — gjør det pent (håndterer æøå).
  ...
  function mapItem(a) {
    ...
    // Full visningsstreng som blir stående i feltet ved valg.
    o.formatted = o.adressetekst + (o.poststed ? ', ' + o.postnummer + ' ' + o.poststed : '');
    return o;
  }
  ...
  window.initAddressAutocomplete = function (input, opts) {
    ...
    function choose(i) {
      ...
      input.value = it.formatted;   // full adresse med postnr/poststed blir stående
      close();
